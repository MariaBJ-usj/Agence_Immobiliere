...
// */
//@WebServlet("/ServletPrincipal7JPQL")
//public class ServletPrincipal7JPQL extends HttpServlet {
//	private static final long serialVersionUID = 1L;
//    private DataSource dataSource = null;
//
//    //Usage direct d'un EJB via la no-interface-view
//    //@EJB
//    //ServicesCompteBean servicesCompteBean;
//
//    //Usage d'un EJB au traves de sa business interface
//    @EJB
...
//            HttpServletResponse response) throws ServletException, IOException {
//        try {
//        	System.out.println("M thode doPostVersion6");
//            response.setContentType("text/html");
//            String noDeCompte = request.getParameter("noDeCompte");
//            Compte unCompte = new Compte();
//            unCompte.setNocompte(noDeCompte);
...
//                    .lookup("java:global/webProject/ServicesCompteBean!ejb.ServicesCompte");
//
